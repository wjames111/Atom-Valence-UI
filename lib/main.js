...
alert(toot.innerHTML)
  ...
  let colorsAdded = [
   'wills-theme-ui.colors.customAccent',
   'wills-theme-ui.colors.accentColor',
   'wills-theme-ui.colors.customCaret',
   'wills-theme-ui.colors.colorCaret',
  ]
...
// let content = [ '@color-setting:' + atom.config.get('wills-theme-ui.colors.accentColor') + ';',
// '@caret-setting:' +  atom.config.get('wills-theme-ui.colors.colorCaret') + ';' ]



function changeColor() {
  let theme = 'wills-theme-ui.colors.'
  let currentAccent = atom.config.get(theme + 'customAccent')? 'rgba(197, 196, 124, 1)' : atom.config.get(theme + 'accentColor');
  let currentCaret = atom.config.get(theme + 'customCaret')? '#d56f3e' : atom.config.get(theme + 'colorCaret');

  let content = [ `@color-setting: ${currentAccent};`, `@caret-setting: ${currentCaret};` ]
